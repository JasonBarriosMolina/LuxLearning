...
// ── sanitizeUserPromptForImage ────────────────────────────────────────────────
// bedrock is exported from ctx — spy directly rather than re-mocking BedrockRuntimeClient
...
describe('sanitizeUserPromptForImage', () => {
  ...
  beforeEach(async () => {
    ...
    bedrock = ctx.bedrock;
    sanitize = ctx.sanitizeUserPromptForImage;
...
describe('generateLessonInfographic', () => {
  ...
  beforeEach(async () => {
    ...
    generateLessonInfographic = ctx.generateLessonInfographic;
    vi.spyOn(bedrock,   'send');
