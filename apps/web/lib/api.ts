...
export const api = {
  ...
  admin: {
    ...
    scheduler: {
      ...
      approve: (body: { academicPeriod: string; proposal: any; courseTitles?: Record<string, string>; teacherNames?: Record<string, string>; studentNames?: Record<string, string>; roomNames?: Record<string, string> }) =>
