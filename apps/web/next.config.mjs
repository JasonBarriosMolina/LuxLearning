...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(self), microphone=(self), geolocation=()' },
  {
    ...
    value: [
      ...
      "media-src 'self' blob: https://lux-learning-images.s3.amazonaws.com https://lux-learning-images-test.s3.amazonaws.com https://lux-learning-images-staging.s3.amazonaws.com",
...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'lux-learning-images-test.s3.amazonaws.com' },
      { protocol: 'https', hostname: 'lux-learning-images-staging.s3.amazonaws.com' },
    ],
  },
