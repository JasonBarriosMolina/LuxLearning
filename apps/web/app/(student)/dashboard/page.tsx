...
import { BookOpen, TrendingUp, CheckCircle, Clock, ArrowRight, Lock, Award, Flame, X, ClipboardList, Calendar, AlertCircle, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
import { StudyPlanWidget } from './_components/StudyPlanWidget';
...
export default function StudentDashboardPage() {
  ...
  useEffect(() => {
    ...
    api.studyPlan.current().then((res: any) => {
      const d = res?.data ?? res;
      if (d?.days) setCurrentPlan(d);
    }).catch(() => {});
  }, [lang]);
    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <StudyPlanWidget currentPlan={currentPlan} planLoading={planLoading} lang={lang} />
